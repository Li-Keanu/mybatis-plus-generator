...
public class MybatisPlusCodeAutoGeneration {
    public static void main(String[] args) {
        ...
        //手动配置数据源
        String url="jdbc:mysql://192.168.56.10:3306/gulimall_pms?serverTimezone=UTC&useUnicode=true&characterEncoding=utf-8";   //注意修改数据库名
        String name="root";
        String password="root";

        //数据库表的设置
        List<String> listTable = Arrays.asList("pms_attr");  //设置需要自动代码生成的表名
        // List<String> listTableSuffix = Arrays.asList("_b");    //设置 过滤 表的后缀
        // List<String> listTablePrefix = Arrays.asList("t_","c_"); //设置 过滤 表的后缀

        //基本信息
        String author = "keanu";    //作者
